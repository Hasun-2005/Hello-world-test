...
SECRET_KEY = 'django-insecure-v*#_+r9*wzol%bw^9+$98#pi2$e_wbdpff(#3im7#mh10(&%^m'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Define ALLOWED_HOSTS
ALLOWED_HOSTS = [".railway.app"]  # Allow Railway app domain

# Update ALLOWED_HOSTS if in DEBUG mode
if DEBUG:
